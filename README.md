...
<div align="center">
<img src="screenshots/Screenshot 4.png" alt="Monte Carlo Results" width="400">
</div>
...
<U>variable</U>: the observed quantity during for the period: for examples: 
...
- withdrawals = amount of asset cashed and withdrawn from the portfolio during the period

<U>risk</U>: the class of asset to which the amount value corresponds

<U>value</U>: the value of the amount of the variable
...
## Editing credits
Grok assisted Alex Scherer in editing this readme file, most significantly by proposing verbiage for the sections analyzing how the code works and proposing gramar and stylistic corrections. 
